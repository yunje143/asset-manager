    ...
    <div className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow overflow-hidden">
      <div className="p-6">
        ...
        <div className="space-y-2 mb-6 pb-6 border-b border-gray-200">
          <DetailRow label="Purchase Price" value={`¥${property.purchase_price.toLocaleString()}`} />
        ...
        <div className="flex gap-2">
          <button className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
